...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapApp = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/MapApp\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'label',
	            { htmlFor: 'username', className: 'col-sm-2' },
	            'Username: '
	          ),
	          React.createElement(
	            'div',
	            { className: 'col-sm-10' },
	            React.createElement('input', { id: 'username', type: 'text', name: 'username', className: 'form-control' })
	          )
	        ),
	        React.createElement(
	          'div',
